...
export interface ApiAcademicProgramAcademicProgram
  ...
  attributes: {
    ...
    description: Attribute.RichText &
      ...
      >;
    fee_structure: Attribute.RichText &
      Attribute.CustomField<
        'plugin::ckeditor.CKEditor',
        {
          output: 'HTML';
...
export interface ApiDownloadDownload extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    downloadfile: Attribute.Media<'files'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiShortCourseShortCourse extends Schema.CollectionType {
...
export interface ApiSliderSlider extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    slug: Attribute.UID<'api::slider.slider', 'title'>;
...
export interface ApiUpcomingUpcoming extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    slug: Attribute.UID<'api::upcoming.upcoming', 'title'>;
    description: Attribute.RichText;
    rank: Attribute.Integer;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
